...
##### 00*. load the "crabs" dataset in the MASS package
...
```{r}
blueCrabs$color = NA # add a new column to the data.frame, and assign "dummy" values for now
blueCrabs$color[blueCrabs$sex == "F"] = "red" # now assign "red" to the new column when rats are femals
blueCrabs$color[blueCrabs$se == "M"] = "blue" # now assign "blue" when they are males
